...
import { ArrowRight, Bot, Check, Clock3, ListChecks, NotebookTabs, Plus, Search, Settings, Users } from 'lucide-react'
...
function RecipeCard({ recipe, selected, onToggle }: {
  ...
  return (
    <article className={`recipe-card selectable${selected ? ' selected' : ''}`}>
      <button className="recipe-card-toggle" type="button" aria-pressed={selected} onClick={onToggle}>
