  ...
  },
  {
    ...
    children: [{
      ...
      children: [
        ...
        { path: 'saved/recipes/new', lazy: async () => ({ Component: (await import('../../routes/RecipeRoutes')).RecipeEditorPage }) },
        { path: 'saved/recipes/:recipeId/edit', lazy: async () => ({ Component: (await import('../../routes/RecipeRoutes')).RecipeEditorPage }) },
        { path: 'cooking', lazy: async () => ({ Component: (await import('../../routes/CookingRoutes')).CookingPage }) },
        { path: 'cooking/recipes', lazy: async () => ({ Component: (await import('../../routes/RecipeRoutes')).CookingRecipeSelectPage }) },
